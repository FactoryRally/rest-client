...
namespace Tgm.Roborally.Api.Api
{
    ...
    public interface IConsumerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<JoinResponse> RegisterConsumerAsync(int gameId, ConsumerRegistration consumerRegistration = default(ConsumerRegistration), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<JoinResponse>> RegisterConsumerWithHttpInfoAsync(int gameId, ConsumerRegistration consumerRegistration = default(ConsumerRegistration), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ConsumerApi : IConsumerApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JoinResponse</returns>
        public async System.Threading.Tasks.Task<JoinResponse> RegisterConsumerAsync(int gameId, ConsumerRegistration consumerRegistration = default(ConsumerRegistration), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Tgm.Roborally.Api.Client.ApiResponse<JoinResponse> localVarResponse = await RegisterConsumerWithHttpInfoAsync(gameId, consumerRegistration, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (JoinResponse)</returns>
        public async System.Threading.Tasks.Task<Tgm.Roborally.Api.Client.ApiResponse<JoinResponse>> RegisterConsumerWithHttpInfoAsync(int gameId, ConsumerRegistration consumerRegistration = default(ConsumerRegistration), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<JoinResponse>("/games/{game_id}/consumers", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
