...
namespace Tgm.Roborally.Api.Api
{
    ...
    public interface IEventHandlingApiSync : IApiAccessor
    {
        ...
        /// <param name="wait">If this is true the server will not responde until there is an event. This prevents fast fetching/active waiting. The server will leave the connection open. &gt; Keep in mind that the connection might times out of no event occurs within the timeout time-frame (optional, default to false)</param>
        /// <returns>GenericEvent</returns>
        GenericEvent FetchNextEvent (int gameId, bool? wait = default(bool?));
        ...
        ApiResponse<GenericEvent> FetchNextEventWithHttpInfo (int gameId, bool? wait = default(bool?));
        /// <summary>
        /// trace event
        /// </summary>
        /// <remarks>
    ...
    public interface IEventHandlingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GenericEvent> FetchNextEventAsync (int gameId, bool? wait = default(bool?));
        ...
        System.Threading.Tasks.Task<ApiResponse<GenericEvent>> FetchNextEventAsyncWithHttpInfo (int gameId, bool? wait = default(bool?));
        /// <summary>
        /// trace event
        /// </summary>
        /// <remarks>
    ...
    public partial class EventHandlingApi : IEventHandlingApi
    {
        ...
        /// <param name="wait">If this is true the server will not responde until there is an event. This prevents fast fetching/active waiting. The server will leave the connection open. &gt; Keep in mind that the connection might times out of no event occurs within the timeout time-frame (optional, default to false)</param>
        /// <returns>GenericEvent</returns>
        public GenericEvent FetchNextEvent (int gameId, bool? wait = default(bool?))
        {
             Tgm.Roborally.Api.Client.ApiResponse<GenericEvent> localVarResponse = FetchNextEventWithHttpInfo(gameId, wait);
        ...
        /// <param name="wait">If this is true the server will not responde until there is an event. This prevents fast fetching/active waiting. The server will leave the connection open. &gt; Keep in mind that the connection might times out of no event occurs within the timeout time-frame (optional, default to false)</param>
        /// <returns>ApiResponse of GenericEvent</returns>
        public Tgm.Roborally.Api.Client.ApiResponse< GenericEvent > FetchNextEventWithHttpInfo (int gameId, bool? wait = default(bool?))
        {
        ...
        /// <param name="wait">If this is true the server will not responde until there is an event. This prevents fast fetching/active waiting. The server will leave the connection open. &gt; Keep in mind that the connection might times out of no event occurs within the timeout time-frame (optional, default to false)</param>
        /// <returns>Task of GenericEvent</returns>
        public async System.Threading.Tasks.Task<GenericEvent> FetchNextEventAsync (int gameId, bool? wait = default(bool?))
        {
             Tgm.Roborally.Api.Client.ApiResponse<GenericEvent> localVarResponse = await FetchNextEventAsyncWithHttpInfo(gameId, wait);
             return localVarResponse.Data;
        ...
        /// <param name="wait">If this is true the server will not responde until there is an event. This prevents fast fetching/active waiting. The server will leave the connection open. &gt; Keep in mind that the connection might times out of no event occurs within the timeout time-frame (optional, default to false)</param>
        /// <returns>Task of ApiResponse (GenericEvent)</returns>
        public async System.Threading.Tasks.Task<Tgm.Roborally.Api.Client.ApiResponse<GenericEvent>> FetchNextEventAsyncWithHttpInfo (int gameId, bool? wait = default(bool?))
        {
