...
namespace Tgm.Roborally.Api.Api
{
    ...
    public interface IMapRepoApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void SaveMap (string name, Map map = default(Map));
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SaveMapWithHttpInfo (string name, Map map = default(Map));
    ...
    public interface IMapRepoApiAsync : IApiAccessor
    {
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task SaveMapAsync (string name, Map map = default(Map));
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> SaveMapAsyncWithHttpInfo (string name, Map map = default(Map));
    ...
    public partial class MapRepoApi : IMapRepoApi
    {
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns></returns>
        public void SaveMap (string name, Map map = default(Map))
        {
             SaveMapWithHttpInfo(name, map);
        }
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Tgm.Roborally.Api.Client.ApiResponse<Object> SaveMapWithHttpInfo (string name, Map map = default(Map))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new Tgm.Roborally.Api.Client.ApiException(400, "Missing required parameter 'name' when calling MapRepoApi->SaveMap");
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SaveMapAsync (string name, Map map = default(Map))
        {
             await SaveMapAsyncWithHttpInfo(name, map);
        ...
        /// <param name="map">The map to save (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Tgm.Roborally.Api.Client.ApiResponse<Object>> SaveMapAsyncWithHttpInfo (string name, Map map = default(Map))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new Tgm.Roborally.Api.Client.ApiException(400, "Missing required parameter 'name' when calling MapRepoApi->SaveMap");
