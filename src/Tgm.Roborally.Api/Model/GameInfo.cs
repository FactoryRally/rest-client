...
namespace Tgm.Roborally.Api.Model
{
    ...
    public partial class GameInfo :  IEquatable<GameInfo>, IValidatableObject
    {
        ...
        public GameInfo(int passedTime = -1, GameState state = default(GameState), bool hardwareCompatible = false, int playerOnTurn = default(int), string name = default(string), int maxPlayers = default(int), int currentPlayers = default(int))
        {
