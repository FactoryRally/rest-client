...
namespace Tgm.Roborally.Api.Model
{
    ...
    public partial class GameInfo :  IEquatable<GameInfo>, IValidatableObject
    {
        ...
        /// <param name="animationDelay">The delay in &#x60;ms&#x60; that will be used to give clients the oportulity to play animations after executed commands and other animatable events (required) (default to 1500).</param>
        public GameInfo(int passedTime = -1, GameState state = default(GameState), bool hardwareCompatible = false, int playerOnTurn = default(int), string name = default(string), int maxPlayers = default(int), int currentPlayers = default(int), GameInfoExecutionInfo executionInfo = default(GameInfoExecutionInfo), bool passwordProtected = default(bool), int animationDelay = 1500)
        {
        ...
        /// <summary>
        /// The delay in &#x60;ms&#x60; that will be used to give clients the oportulity to play animations after executed commands and other animatable events
        /// </summary>
        /// <value>The delay in &#x60;ms&#x60; that will be used to give clients the oportulity to play animations after executed commands and other animatable events</value>
        [DataMember(Name="animation-delay", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AnimationDelay: ").Append(AnimationDelay).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(GameInfo input)
        {
            ...
            return 
                ...
                (
                    this.AnimationDelay == input.AnimationDelay ||
                    this.AnimationDelay.Equals(input.AnimationDelay)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AnimationDelay.GetHashCode();
                return hashCode;
            }
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AnimationDelay (int) maximum
            if(this.AnimationDelay > (int)10000)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AnimationDelay, must be a value less than or equal to 10000.", new [] { "AnimationDelay" });
            }

            // AnimationDelay (int) minimum
            if(this.AnimationDelay < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AnimationDelay, must be a value greater than or equal to 0.", new [] { "AnimationDelay" });
            }
