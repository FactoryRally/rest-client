...
namespace Tgm.Roborally.Api.Model
{
    ...
    public partial class GameRules :  IEquatable<GameRules>, IValidatableObject
    {
        ...
        /// <param name="animationDelay">Sets GameInfo.animation-delay (default to 1500).</param>
        public GameRules(bool playerNamesVisible = true, int maxPlayers = 4, string name = default(string), int robotsPerPlayer = default(int), string password = default(string), bool fillWithBots = false, int animationDelay = 1500)
        {
        ...
        /// <summary>
        /// Sets GameInfo.animation-delay
        /// </summary>
        /// <value>Sets GameInfo.animation-delay</value>
